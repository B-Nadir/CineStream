      ...
      try {
        ...
        if (debouncedSearch) {
          ...
          const res = await fetch(
            `http://localhost:5000/search?type=movies&query=${encodeURIComponent(debouncedSearch)}`
          );
          ...
          list =
            ...
            Array.isArray(response.movies) ? response.movies : [];
        ...
        if (sorted.length > 100) {
          ...
          setMovies(sorted.slice(start, start + 100));
        } else {
          setMovies(sorted);
        }
        ...
        <>
          ...
          >
            {movies.map((show, index) => (
              ...
              >
                <ShowCard show={{ ...show, show_type: "movie" }} />
              </div>
            ))}
          </div>
